...
public class IsAlphabet extends IsRegexpFormat {

	public IsAlphabet(HttpServletRequest req, HttpServletResponse res, IndexInformation info) {
		super(req, res, info);
	}
	...
	public boolean doValidate(HttpServletRequest req, HttpServletResponse res, String value, IndexInformation info) throws Exception {
		return checkRegexpFormat(value, "^[a-zA-Z]*$");
	}
}
